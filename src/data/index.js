export default [
  ...
  },
  {
    ...
    year: 2020,
    votes: 1895,
    genreIds: [28, 27, 878, 53],
    description:
      "After an earthquake destroys their underwater station, six researchers must navigate two miles along the dangerous, unknown depths of the ocean floor to make it to safety in a race against time.",
  },
  {
    title: "W lesie dziś nie zaśnie nikt",
    year: 2020,
    votes: 233,
    genreIds: [27],
    description:
  ...
  },
  {
    ...
    genreIds: [18, 28, 53],
    description:
      "Four young men who want to leave their dystopian world behind and go to a distant paradise execute a money robbery, a daring act that will have unexpected consequences.",
  },
]
